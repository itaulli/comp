...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_Arr2d')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_Arr2d')
    _Arr2d = swig_import_helper()
    ...
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_Arr2d', [dirname(__file__)])
        except ImportError:
            import _Arr2d
            return _Arr2d
        try:
            _mod = imp.load_module('_Arr2d', fp, pathname, description)
        finally:
            if fp is not None:
                fp.close()
        return _mod
...
class Arr2d(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, Arr2d, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, Arr2d, name)
    __repr__ = _swig_repr

    def __init__(self, *args):
        this = _Arr2d.new_Arr2d(*args)
        try:
