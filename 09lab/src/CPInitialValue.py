...
class MultiLeap(CPInitialValueSolver):
    __swig_setmethods__ = {}
    for _s in [CPInitialValueSolver]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, MultiLeap, name, value)
    __swig_getmethods__ = {}
    for _s in [CPInitialValueSolver]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, MultiLeap, name)
    __repr__ = _swig_repr

    def __init__(self, nSpatialPoints: 'unsigned int', c: 'double', dt: 'double', dx: 'double', nthreads: 'unsigned int'):
        this = _CPInitialValue.new_MultiLeap(nSpatialPoints, c, dt, dx, nthreads)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _CPInitialValue.delete_MultiLeap
    __del__ = lambda self: None
MultiLeap_swigregister = _CPInitialValue.MultiLeap_swigregister
MultiLeap_swigregister(MultiLeap)
